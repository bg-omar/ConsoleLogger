...
import com.github.bgomar.consolelogger.tools.TimestampTools;
import com.github.bgomar.consolelogger.toolwindow.ComboBoxWithImageItem;
import com.github.bgomar.consolelogger.toolwindow.ComboBoxWithImageRenderer;
    ...
    public void setup() {
        ...
        zoneIds.forEach(zoneId -> {
            ...
            timestampTimezoneComboBox.addItem(new ComboBoxWithImageItem(
                zoneId, "consolelogger/flags/" + flag + ".svg"));
        });
        ...
        timestampNowButton.setIcon(IconLoader.getIcon("consolelogger/toolicons/refresh.svg", ConsoleLoggerToolWindow.class));
        timestampUpdateFromTimestampButton.setIcon(IconLoader.getIcon("consolelogger/toolicons/refresh.svg", ConsoleLoggerToolWindow.class));
        timestampUpdateFromFieldsButton.setIcon(IconLoader.getIcon("consolelogger/toolicons/refresh.svg", ConsoleLoggerToolWindow.class));
