...
To easily create and remove console.log in your IDE.  
...
<!-- Plugin description -->
####  `CTRL + ALT + (1-9)` for console.logs [<img src="https://github.com/bg-omar/consolelogger/blob/master/.github/pics/devcat.png?raw=true"  width="24px"/>]() 
...
#### [<img src="https://github.com/bg-omar/consolelogger/blob/master/.github/pics/preview_1.png?raw=true" width="500px"/>]()  
## Consider this code
#### [<img src="https://github.com/bg-omar/consolelogger/blob/master/.github/pics/preview_2.png?raw=true" width="500px%"/>]()
## `Ctrl + Alt + 1`  on `this.some_return_function(variable)`  
#### [<img src="https://github.com/bg-omar/consolelogger/blob/master/.github/pics/preview_3.png?raw=true" width="500px%"/>]()  
## Which will show in console
#### [<img src="https://github.com/bg-omar/consolelogger/blob/master/.github/pics/preview_4.png?raw=true" width="500px%"/>]()
## The toolwindow to adjust the loggers
#### [<img src="https://github.com/bg-omar/consolelogger/blob/master/.github/pics/preview_5.png?raw=true" width="500px%"/>]()
## Remove all loggers  
### `(CTRL + ALT + 0)`  
#### [<img src="https://github.com/bg-omar/consolelogger/blob/master/.github/pics/preview_6.png?raw=true" width="300px%"/>]()  
